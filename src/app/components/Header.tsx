...
export function Header() {
  return (
    <header className="h-16 bg-[#131827] border-b border-[#1E293B] flex items-center justify-between px-6">
      {/* Search Bar */}
      <div className="flex-1 max-w-2xl">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search across all value streams..."
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 bg-[#A855F7]/10 border border-[#A855F7]/30 rounded-md px-2.5 py-1">
            ...
            <span className="text-xs text-[#A855F7]">AI Search</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-[#1E293B]">
          <div className="text-right">
            ...
            <div className="text-xs text-[#94A3B8]">Head of Ops</div>
          </div>
